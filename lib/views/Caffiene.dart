...
class Caffiene extends StatefulWidget {
  @override
  _Caffiene createState() => _Caffiene();
}

class _Caffiene extends State<Caffiene> {
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              child: Align(
                                ...
                                heightFactor: 0.50,
                                child: Image(image: AssetImage('images/coffee/1.jpg')),
                              ),
                            ),
                          ),
                        ),
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              child: Align(
                                alignment: Alignment.center,
                                heightFactor: 0.50,
                                child: Image(image: AssetImage('images/coffee/4.jpg')),
                              ),
                            ),
                          ),
                        ),
