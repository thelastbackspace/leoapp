...
class DetectOtp extends StatefulWidget {
  Map data;
   DetectOtp({Key key, this.data}) : super(key: key);
  @override
  _DetectOtpState createState() => _DetectOtpState();
}

class _DetectOtpState extends State<DetectOtp> {
                  ...
                  child:PinFieldAutoFill(
                    ...
                    onCodeChanged: (code){
                     if (code.length == 4) {
                      ...
                      if(code == "1234"){
                     signIn(code, widget.data["name"], widget.data["number"]);
                      }
                      else
                      print("notsame");
                    }
...
void _listenOtp() async {
  ...
  signIn(code,String name,number) async {
    print("Working");
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    Map data = {'name':name, 'number':number, 'otpverified':'yes'};
    ...
    if (response.statusCode == 200) {
     ...
     if (jsonResponse != null) {
          ...
          sharedPreferences.setString("user",jsonResponse['user']);
