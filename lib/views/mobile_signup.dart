...
import 'package:leo/views/detectotp.dart';
            ...
            child:ListView(
               //CrossAxisAlignment.center,
                ...
                padding: EdgeInsets.fromLTRB(0, 0, 0, 20),
                          child: Text('You are already registered, please login',
...
Container(
        ...
        Padding(padding: EdgeInsets.fromLTRB(20, 40, 20, 0),
                ...
                child: FlatButton(
                    onPressed:() 
                      ...
                      //       },
                    {
                    if(nameController.text !="" && numberController.text != "" && numberproceed==true){
                    print('Signin working');
                      setState(() {
                              _isLoading = true;
                            });
                            signIn(nameController.text,numberController.text);
  ...
  signIn(String name,number) async{
    print("Working");
   // SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    Map data = {'name':name, 'number':number};
    var jsonResponse = null;
    var response =
        await http.post("https://leomenu.com/leoapp/public/api/checknumber", body: data);
    ...
    Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(builder: (BuildContext context) => DetectOtp(data: data)),
