...
import 'package:leo/views/detectloginotp.dart';
            ...
            child:ListView(
               //CrossAxisAlignment.center,
                ...
                padding: EdgeInsets.fromLTRB(0, 0, 0, 20),
                          child: Text('Please enter valid number',
        ...
        Padding(padding: EdgeInsets.fromLTRB(20, 40, 20, 0),
                ...
                child: FlatButton(
                    onPressed:() 
                      ...
                      //       },
                    {
                    if(numberController.text != "" && numberproceed==true){
                    print('Signin working');
                      setState(() {
                              _isLoading = true;
                            });
                            signIn(numberController.text);
  ...
  signIn(number) async{
   ...
   // SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    ...
    Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(builder: (BuildContext context) => DetectLoginOtp(data: data)),
